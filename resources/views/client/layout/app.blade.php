...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('client/css/crumina-fonts.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('client/css/normalize.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('client/css/grid.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('client/css/styles.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('client/css/custom-styles.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('client/css/primary-menu.css') }}">
...
<body class=" ">
                    ...
                    <div class="row">
                        <div class="subscribe scrollme">
                            ...
                            <div class="images-block">
                                <img src="{{asset('client/img/subscr-gear.png') }}" alt="gear" class="gear">
                                <img src="{{asset('client/img/subscr1.png') }}" alt="mail" class="mail">
                                <img src="{{asset('client/img/subscr-mailopen.png') }}" alt="mail" class="mail-2">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{asset('client/js/crum-mega-menu.js') }}"></script>
    <script src="{{asset('client/js/swiper.jquery.min.js') }}"></script>
    <script src="{{asset('client/js/theme-plugins.js') }}"></script>
    <script src="{{asset('client/js/main.js') }}"></script>
    {{--
    <script src="{{asset('client/js/form-actions.js') }}"></script> --}}

    <script src="{{asset('client/js/velocity.min.js') }}"></script>
    <script src="{{asset('client/js/ScrollMagic.min.js') }}"></script>
    <script src="{{asset('client/js/animation.velocity.min.js') }}"></script>
